...
public class Example2 {
    ...
    public static void main(String[] args) {
        ...
        // Создание обЪекта класса Scanner для считывания значения введенного в консоль
        Scanner in = new Scanner(System.in);
        // Запись в переменную dayOfWeek
        ...
        switch (s) {
            ...
            default:
                // Сообщение пользователю (сработает если будет введено некорректное значение)
