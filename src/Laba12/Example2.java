...
public class Example2 {
    ...
    public static void main(String[] args) {
        ...
        int[] arrResult = funcElment(arr1, arr2);
        System.out.println("Массив arrResult : ");
        System.out.println(Arrays.toString(arrResult));
    }
    public static int[] funcElment(int[] arr1, int[] arr2) {
        return Arrays.stream(arr1).filter(x -> Arrays.stream(arr2).anyMatch(a -> a == x)).toArray();
    }
}
